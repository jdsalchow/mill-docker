...
|Source image for the container. Examles of all possible source image types can be found link:mill-docker/test/resources/examples-imagetypes[here].
|X
...
|Task[(JibContainerBuilder, Vector[FileEntriesLayer], Vector[String])] => Task[JibContainerBuilder]
|Hook to modify the JibContainerBuilder before building the container. See the example link:mill-docker/test/resources/examples-customjibbuild[here].
|

|javaContainerBuilderHook
|Task[JavaContainerBuilder] => Task[JavaContainerBuilder]
|Hook to modify the JavaContainerBuilder before building the container. See the example link:mill-docker/test/resources/examples-jvmagent[here].
|
|===
