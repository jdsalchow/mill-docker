...
trait DockerJibModule extends Module { outer: JavaModule =>
  ...
  trait DockerConfig extends mill.Module {
    ...
    /** The JavaContainerBuilder before it is used to build the container. 
      * This will setup the JavaContainer in default Jib Java Layer format
      * @return
    ...
    /** This method mainly exists to allow for customization of the JibContainerBuilder.
      * It first creates a JavaContainerBuilder via the Java Builder and then converts it to a JibContainerBuilder.
      * 
